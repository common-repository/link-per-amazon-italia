<?php
/*
Plugin URI: https://www.wpefficaceclub.it/plugins/
Plugin Name: Link per Amazon Italia
Description: Mostra link affiliati per Amazon Italia
Version: 1.2
Date: March 17h, 2017
Author: WPefficaceClub
Author URI: https://www.wpefficaceclub.it
...
$PLUGINMATRIX_NAME='Link_Amazon';

if(!class_exists($PLUGINMATRIX_NAME))
{
    class Link_Amazon extends WP_Widget
    {
	...
	protected $display_mode=null;
		...
		$widget_options = [
		      'classname' => __CLASS__,
		      'description' => 'This is an '.__CLASS__,
		];
	...
	public function customCode($caller){
		...
		switch($caller){
			case "shortcode":
				...
				// put customcode here for shortcode
			        $title=!empty($this->title)?"<h2>".$this->title."</h2>":'';
